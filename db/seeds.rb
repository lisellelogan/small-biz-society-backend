...
trash_to_treasure.small_business_items.create([
    ...
    {name: "Ringin'", price: 78.50, description: "A gold ring set that will blow Thanos out of this universe.", image_url: "https://images.unsplash.com/photo-1608042314453-ae338d80c427?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1040&q=80", type: "Jewelry"}
])